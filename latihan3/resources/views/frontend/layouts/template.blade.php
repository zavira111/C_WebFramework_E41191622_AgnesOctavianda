...
<head>
  ...
  <link href="{{ assets('fronten/assets/d/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
  ...
  <link href="{{ assets('frontend/assets/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet')}}">
